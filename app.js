 ...
 function chooseArea(block){
    if (block.textContent ==='') {
        ...
        errorText.textContent = "hey,bu xana bos deyil"
...
function checkDiagnoals() {
    let dig1 = blocks[0].textContent == blocks[4].textContent && blocks[0].textContent == blocks[8].textContent  && blocks[0].textContent !==""
    let dig2 = blocks[2].textContent == blocks[4].textContent && blocks[2].textContent == blocks[6].textContent  && blocks[2].textContent !==""
    if (dig1 || dig2 ) {
        gameOver = true
    }
    if (dig1) return winner = blocks[0].textContent
    if (dig2) return winner = blocks[2].textContent
}
